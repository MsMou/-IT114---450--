...
public class Room implements AutoCloseable {
	...
	private void muteSaveList() {
        try (ObjectOutputStream outputStream = new ObjectOutputStream(new FileOutputStream("mutedList.dat"))) {
	...
	private void muteLoadList() {
    try (ObjectInputStream inputStream = new ObjectInputStream(new FileInputStream("mutedList.dat"))) {
