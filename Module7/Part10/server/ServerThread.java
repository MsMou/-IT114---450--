...
import Module7.Part10.common.PayloadType;
import Module7.Part10.common.RoomResultPayload;
...
public class ServerThread extends Thread {
    ...
    public boolean isLastMessageSender() {
        return getClientName().equals(lastMessageSenderName);
    }
    ...
    public boolean sendMessage(long clientId, String message) {
        ...
        if (clientId != Constants.DEFAULT_CLIENT_ID) {
            lastMessageSenderName = getClientName();
        }
        return send(p);
    }
