...
public class RoomsPanel extends JPanel {
    ...
    JLabel message;
    private List<String> commonChatHistory;
    private static Logger logger = Logger.getLogger(RoomsPanel.class.getName());
    private ChatPanel chatPanel;

    public RoomsPanel(ICardControls controls, ChatPanel chatPanel, List<String> commonChatHistory) {
        super(new BorderLayout(10, 10));
        this.chatPanel = chatPanel;
        this.commonChatHistory = commonChatHistory;
        ...
        JButton chatHistoryButton = new JButton("History");
        chatHistoryButton.addActionListener((event) -> {
            String chatHistory = chatPanel.getFormattedChatHistory();
            if (!chatHistory.isEmpty()) {
                JOptionPane.showMessageDialog(this, chatHistory, "Chat History", JOptionPane.PLAIN_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "No chat history available.", "Chat History", JOptionPane.INFORMATION_MESSAGE);
            }
        });
        ...
        searchContent.add(chatHistoryButton);
