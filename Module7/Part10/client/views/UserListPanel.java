...
public class UserListPanel extends JPanel {
    ...
    protected void addUserListItem(long clientId, String clientName, boolean isMuted, boolean isLastMessageSender) {
        ...
        if (isMuted) {
            textContainer.setForeground(Color.GRAY); // Set the text color to gray
        
         // Highlight the last message sender with yellow color
         } else {
            textContainer.setForeground(Color.BLACK); // Reset text color
         }
